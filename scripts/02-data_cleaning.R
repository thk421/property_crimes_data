...
cleaned_data <- raw_data %>%
  ...
  # Combine different Break & Enter property types into a single
  # Home Invasion crime category
  ...
  # Make a new column called 'covid_period' to indicate if the
  # report was before or after 2020
